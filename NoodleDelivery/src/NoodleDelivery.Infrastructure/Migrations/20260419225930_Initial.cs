        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductPrice_UnitPrice", "\"UnitPrice\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItem_QuantityKg", "\"QuantityKg\" >= 0 AND \"QuantityKg\" <= 1000000");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_Date_DriverId_RestaurantId",
                table: "Orders",
                columns: new[] { "Date", "DriverId", "RestaurantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_ProductId_EffectiveFrom",
                table: "ProductPrices",
